        ...
        {isMenuOpen && (
          ...
          >
            ...
            <div className="mt-auto flex justify-center gap-8 pb-10">
              <a href="https://www.instagram.com/gifttisan/" target="_blank" rel="noopener noreferrer">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-start gap-20">
          <div className="flex flex-col items-center lg:items-start gap-8 max-w-lg">
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/gifttisan/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-primary/10 flex items-center justify-center text-primary/60 hover:bg-primary hover:text-white transition-all">
