    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
        <div>
          ...
          <p className="text-charcoal/60 text-sm font-medium mt-1">Found {products.length} treasures match your criteria</p>
        </div>
              ...
              >
                <Link href={`/products/${p.id}`} className="group block">
                  ...
                  <div className="space-y-1">
                    <p className="text-[10px] font-black text-accent uppercase tracking-widest leading-none">{p.artisan.name}</p>
...
export default function SearchPage() {
  return (
    <main className="min-h-screen bg-cream">
      <Navbar />
      <div className="pt-20">
        <Suspense fallback={<div className="container mx-auto px-4 py-20 text-center">Loading treasures...</div>}>
          <SearchResults />
        </Suspense>
      </div>
    </main>
