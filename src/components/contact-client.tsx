              ...
              <div className="flex items-start gap-5 group">
                ...
                <div>
                  ...
                  <div className="flex gap-4 mt-4">
                     <a href="https://www.instagram.com/giftisan_eg/" target="_blank" rel="noopener noreferrer" className="text-primary/40 hover:text-accent transition-colors"><FaInstagram className="w-5 h-5" /></a>
                     ...
                     <a href="https://www.tiktok.com/@giftisan.eg" target="_blank" rel="noopener noreferrer" className="text-primary/40 hover:text-accent transition-colors"><FaTiktok className="w-5 h-5" /></a>
                  </div>
                </div>
              </div>
