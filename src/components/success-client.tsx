...
export function SuccessClient({ dict, lang }: { dict: any; lang: string }) {
      ...
      <div className="container mx-auto px-6 pt-24 md:pt-40 pb-20 flex flex-col items-center relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link 
              href={`/${lang}`} 
              className="h-16 px-12 bg-primary text-white font-bold rounded-full hover:bg-brand transition-all shadow-xl shadow-primary/20 flex items-center justify-center gap-2 group w-full sm:w-auto active:scale-95 text-sm md:text-base"
            >
            ...
            <Link 
              href={`/${lang}/favorites`} 
              className="h-16 px-12 bg-white border border-primary/10 text-primary font-bold rounded-full hover:bg-primary/5 transition-all w-full sm:w-auto flex items-center justify-center active:scale-95 text-sm md:text-base"
            >
