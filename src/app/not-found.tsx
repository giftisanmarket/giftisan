...
export default function RootNotFound() {
  return (
    <html lang="en">
      <body className="min-h-screen bg-cream flex flex-col justify-between items-center text-center p-4 font-heading antialiased text-charcoal relative overflow-hidden">
        ...
        <div className="flex-1 flex flex-col items-center justify-center relative z-10 py-16">
          <div className="relative mb-8 md:mb-10">
            <div className="w-28 h-28 md:w-36 md:h-36 bg-white rounded-[2rem] md:rounded-[2.5rem] flex items-center justify-center border border-primary/5 shadow-2xl shadow-primary/10">
              <Compass className="w-14 h-14 md:w-18 md:h-18 text-accent animate-spin" style={{ animationDuration: "12s" }} />
            </div>
          ...
          <p className="text-charcoal/60 max-w-lg mx-auto mb-8 md:mb-10 text-sm sm:text-base md:text-lg leading-relaxed font-medium px-2">
            The page or product you're looking for doesn't exist or has been moved to a new collection.
          </p>
        ...
        <footer className="py-6 md:py-8 border-t border-primary/5 text-center relative z-10 w-full">
